...
function fDatosPerfil(){
    ...
    `   <div id="tit" > Tú Perfil </div>
        ...
        <div class="bp"> <input type="button" class="b" id="z" value="Foto" onclick="fAbrirNuevaFoto()" > </div>
        <div class="bp"> <input type="button" class="b" id="z" value="Cerrar" onclick="fCerrarPerfil()" > </div>`
...
<div id="btC"> <input type="button" class="b" id="z" value="Cerrar" onclick="fCerrarCambioF()" > </div>
